...
def load_reviews_amazon23(reviews_file, max_reviews=None):
    ...
    with open_text(reviews_file) as f:
...
def parse_args():
    ...
    parser.add_argument("--max_reviews", type=int, default=None,
                        help="Read at most this many raw reviews for a reproducible small run")
...
def main():
    ...
    reviews = load_reviews_amazon23(args.reviews_file, args.max_reviews)
